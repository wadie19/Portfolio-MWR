    ...
    return (
        <div>
            <nav className="fixed left-0 right-0 top-4 z-50">
                {/**menu pour pc */}
                <div className="mx-auto hidden max-w-2xl items-center justify-center 
                rounded-lg border border-stone-50/30 bg-black/20  py-30 backdrop-blur-lg lg:flex">
                ...
                <div className="rounded-lg backdrop-blur-md lg:hidden">
                    <div className="flex items-center justify-between">
                        <div>
                            <a href="#">
                                <img src="../src/assets/logo.png" alt="logo" width={90} className="m-2"/>
                            </a>
                        </div>
